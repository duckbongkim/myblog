    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptino', models.CharField(blank=True, help_text='simple one-line-text.', max_length=100, verbose_name='DESCRIPTION')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(verbose_name='CONTENT')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='CREATE DT')),
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='UPDATE DE')),
